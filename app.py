            ...
            try:
                ...
                if t == "join":
                    with rooms_lock:
                        ...
                        raw_skin = data.get("skin", None)
                        # Skin verisi base64 PNG'dir, kötüye kullanımı/bellek şişmesini önlemek için boyut sınırı
                        skin_value = None
                        if isinstance(raw_skin, str) and raw_skin.startswith("data:image/") and len(raw_skin) <= 400_000:
                            skin_value = raw_skin
